...
class RightBottomParts:Parts{
    ...
    override init(superView:UIView,targetImageView:PictureView,dotView:DotView) {
        ...
        self.frame = CGRectMake(targetImageView.frame.origin.x + targetImageView.frame.width + Parts.marginHorizontal,targetImageView.frame.origin.y + targetImageView.frame.height - Parts.marginVertical
