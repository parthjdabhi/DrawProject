...
class LeftBottomParts:Parts{
    ...
    override init(superView:UIView,targetImageView:PictureView,dotView:DotView) {
        ...
        self.frame = CGRectMake(targetImageView.frame.origin.x - Parts.marginHorizontal - self.width,targetImageView.frame.origin.y + targetImageView.frame.height - Parts.marginVertical
    ...
    override func drawRect(rect: CGRect) {
        let line = UIBezierPath(rect:CGRectMake(self.frame.width * 3/5 + self.frame.width/10,self.frame.height * 1/5 - self.frame.height/10,self.frame.width/5,self.frame.height/5))
